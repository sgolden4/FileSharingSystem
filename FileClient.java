...
public class FileClient {
    ...
    public static Map<String, Long> ResumeULList = new HashMap<String, Long>(); 
    ...
    public static void help() {
        System.out.println("Command options are as follows:\n" +
                ...
                "(3) ul <filepath> <Server Name>  :: Uploads file at filepath to the system\n" + 
        ...
        while (true) {
            ...
            try {
                ...
                if (totalWrite != 0) {
                    ...
                    ResumeULList.put(filename + " " + servname, totalWrite);
                } else {
